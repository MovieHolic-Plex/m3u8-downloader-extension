...
- **Merged Downloads**: Downloads and merges all M3U8 segments into a single TS file
...
- **TS Format**: M3U8 videos saved as TS format (high compatibility with VLC, etc.)
